...
source_dir = "./TCAV_folders/"

working_dir = './tcav_class_test'
activation_dir = working_dir + '/activations/'
cav_dir = working_dir + '/cavs/'
bottlenecks = ['encoder', 'extended_classifier', 'summarizer',  'enc_augment' ]
...
target = 'target_right'
concepts = ['leftees', 'righties', 'eyem', 'musc']#["eyem", "musc"]
# random_counterpart = 'random500_1'
#LABEL_PATH = './imagenet_comp_graph_label_strings.txt'

labels = ['target_left', 'target_right']

modelPath = ".\BENDR\BENDR_pretrained\save_BENDR_model_LeftRight.pth"

#BendrModel = LinearHeadBENDR.load()

mymodel = model.BENDRWrapper(labels, modelPath)

#mymodel = model.InceptionV3Wrapper(LABEL_PATH)

act_generator = act_gen.EEGActivationGenerator(
   mymodel, source_dir, activation_dir, max_examples=10)
...
num_random_exp = 20  # folders (random500_0, random500_1)
